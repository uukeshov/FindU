...
public class AboutCreatorActivity extends AppCompatActivity {
   ...
   /* public void callDeveloper(View view) {
        ...
        try {
            ...
            Toast.makeText(AboutCreatorActivity.this, "There no avalable phones", Toast.LENGTH_SHORT).show();
        }
    }*/
    ...
    public void sendEmail(View view) {
        ...
        i.putExtra(Intent.EXTRA_EMAIL, new String[]{"staomania@gmail.com"});
        ...
        try {
            ...
            Toast.makeText(AboutCreatorActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
